...
class UniversidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create universidad" do
    assert_difference('Universidad.count') do
      post universidades_url, params: { universidad: { direccion: @universidad.direccion, nit: @universidad.nit, nombre: @universidad.nombre, telefono: @universidad.telefono } }
    end
  ...
  test "should update universidad" do
    patch universidad_url(@universidad), params: { universidad: { direccion: @universidad.direccion, nit: @universidad.nit, nombre: @universidad.nombre, telefono: @universidad.telefono } }
