...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post estudiantes_url, params: { estudiante: { apellido: @estudiante.apellido, cedula: @estudiante.cedula, direccion: @estudiante.direccion, nombre: @estudiante.nombre, telefono: @estudiante.telefono } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { apellido: @estudiante.apellido, cedula: @estudiante.cedula, direccion: @estudiante.direccion, nombre: @estudiante.nombre, telefono: @estudiante.telefono } }
