...
class AdministradoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrador" do
    assert_difference('Administrador.count') do
      post administradores_url, params: { administrador: { apellido: @administrador.apellido, cedula: @administrador.cedula, direccion: @administrador.direccion, nombre: @administrador.nombre, telefono: @administrador.telefono } }
    end
  ...
  test "should update administrador" do
    patch administrador_url(@administrador), params: { administrador: { apellido: @administrador.apellido, cedula: @administrador.cedula, direccion: @administrador.direccion, nombre: @administrador.nombre, telefono: @administrador.telefono } }
